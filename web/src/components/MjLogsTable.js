...
function renderType(type) {
  switch (type) {
    ...
    case 'INPAINT':
      return <Tag color='green' size='large'> 局部重绘 </Tag>;
    case 'CUSTOMZOOM':
      return <Tag color='green' size='large'> 变焦 </Tag>;
    case 'PAN':
      return <Tag color='green' size='large'> 平移 </Tag>;
    case 'DESCRIBE':
      return <Tag color="yellow" size='large'>图生文</Tag>;
    case 'BLEAND':
      return <Tag color="lime" size='large'>图混合</Tag>;
    case "OUTPAINT":
      return <Tag color='olive' size='large'> 绘图 </Tag>;
    default:
